...
- [macOS-arm64](https://github.com/wjlin0/pathScan/releases/download/v2.1.4/pathScan_2.1.4_macOS_arm64.zip)

- [macOS-amd64](https://github.com/wjlin0/pathScan/releases/download/v2.1.4/pathScan_2.1.4_macOS_amd64.zip)

- [linux-amd64](https://github.com/wjlin0/pathScan/releases/download/v2.1.4/pathScan_2.1.4_linux_amd64.zip)

- [windows-amd64](https://github.com/wjlin0/pathScan/releases/download/v2.1.4/pathScan_2.1.4_windows_amd64.zip)

- [windows-386](https://github.com/wjlin0/pathScan/releases/download/v2.1.4/pathScan_2.1.4_windows_386.zip)
